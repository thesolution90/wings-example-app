...
class GitHubCommit(GitCommit):
    ...
    Der Konstruktor bezieht alle Informationen dafür von GitHub Actions.
    ...
    def __init__(self):
        ...
        github_pipeline_link_url = \
            f'{github_project_url}/actions/runs/{github_pipeline_id}'
        github_test_report_link_url = github_pipeline_link_url

        super().__init__(github_branch_name, github_commit_hash,
                         github_commit_message, github_image_name,
                         github_project_url, github_pipeline_id,
                         github_pipeline_link_url, github_commit_link_url,
                         github_test_report_link_url)
